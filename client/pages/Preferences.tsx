...
import PersonalStyleProfile from "@/components/PersonalStyleProfile";
...
export default function Preferences({
  ...
  const handleProfileUpdate = (profile: UserStyleProfile) => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Top Navigation */}
      <TopNav title="Preferences" theme={theme} onThemeChange={onThemeChange} />
      ...
      <div className="flex-1 px-4 md:px-6 py-8 overflow-y-auto">
        <div className="max-w-2xl mx-auto space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Choose between comfortable spacing or compact layout
                  </p>
                </div>
                <button
                  ...
                  className={cn(
                    "relative w-12 h-7 rounded-full transition-colors duration-200",
                    settings.compactDensity ? "bg-emerald-500" : "bg-slate-700"
                  )}
                >
                  <div
                    className={cn(
          ...
          {/* Section 4: Personal Style Profile */}
